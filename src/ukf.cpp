...
void UKF::Prediction(double delta_t) {
  ...
  */
    //copied from lecture notes, lesson 7.18
    ...
    //copied from lecture notes, lesson 7.21
    ...
    //copied from lecture notes, lesson 7.24
    //mean and covariance
...
void UKF::UpdateRadar(MeasurementPackage meas_package) {
  ...
  */
    ...
    //copied from lecture notes, lesson 7.27
    //transform sigma points into measurement space
    for (int i = 0; i < 2 * n_aug_ + 1; i++) {  //2n+1 simga points
    ...
    //copied from lecture notes, lesson 7.30
    //calculate cross correlation matrix
    Tc.fill(0.0);
    for (int i = 0; i < 2 * n_aug_ + 1; i++) {  //2n+1 simga points
...
double UKF::Normalize(double val) {
    while (val> M_PI) return -2.*M_PI;
    while (val<-M_PI) return 2.*M_PI;
    return 0.;
}
